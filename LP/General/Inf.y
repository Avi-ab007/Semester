...
line	: assignment ';'	  {;}	
		...
		;
assignment	: identifier '=' exp {string s($1) ;val[s]=$3;}
			| identifier PE exp	{string s($1); val[s]+=$3;}
			| identifier ME exp	{string s($1); val[s]-=$3;}
			| identifier SE exp	{string s($1); val[s]*=$3;}
			| identifier DE exp	{string s($1); val[s]/=$3;}
			;	
